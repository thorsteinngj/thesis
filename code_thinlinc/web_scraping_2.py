...
desktop_eg = pd.read_csv('/zhome/2e/9/124284/Downloads/agents(1).csv')[20:40]
...
ids = random.sample(range(50869103+1,2*50869103+1), 300000)
...
for i in tqdm(range(len(ids))):
	if (i%10000)==0:
		...
		df.to_csv('/zhome/2e/9/124284/environments/gravestones_env/Code/Data/website_data_2.csv')
	else:
...
my_dataset_df.to_csv('/zhome/2e/9/124284/environments/gravestones_env/Code/Data/website_data_2.csv')
