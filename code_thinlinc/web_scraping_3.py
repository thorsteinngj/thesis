...
desktop_eg = pd.read_csv('/zhome/2e/9/124284/Downloads/agents(1).csv')[40:60]
...
ids = random.sample(range(2*50869103+1,3*50869103+1), 300000)
...
for i in tqdm(range(len(ids))):
	if (i%10000)==0:
		...
		df.to_csv('/zhome/2e/9/124284/environments/gravestones_env/Code/Data/website_data_3.csv')
	else:
...
my_dataset_df.to_csv('/zhome/2e/9/124284/environments/gravestones_env/Code/Data/website_data_3.csv')
